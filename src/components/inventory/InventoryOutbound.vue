<template>
    <div v-if="isOpen" class="modal-overlay">
      <div class="modal-content">
        ...
        <form @submit.prevent="submitOutbound" class="modal-form">
  ...
  const submitOutbound = async () => {
    try {
        await apiService.createOutbound(outboundData.value);
        emit('refresh');
...
const selectProduct = product => {
  outboundData.value.productName = product.productName // 선택된 제품 이름 반영
